...
**`"extensions"`** (optional): This key provides a way for specific
implementations to store additional ad hoc metadata. If present, its
value should be a JSON object, and each key in this object MUST be a
URL that uniquely and durably identifies the format of the extension
data inside; this URL SHOULD refer to web page providing more
